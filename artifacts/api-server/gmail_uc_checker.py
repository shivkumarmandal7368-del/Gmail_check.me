...
def make_stealth_js(fp: dict) -> str:
    ...
    return f"""
(function(){{var _nts=Function.prototype.toString,_ntm=new WeakMap();Function.prototype.toString=function toString(){{return _ntm.has(this)?_ntm.get(this):_nts.call(this);}};_ntm.set(Function.prototype.toString,'function toString() {{ [native code] }}');Object.defineProperty(window,'__nr',{{value:function(fn,n,g){{if(fn&&typeof fn==='function')_ntm.set(fn,'function '+(g?'get ':'')+n+'() {{ [native code] }}');}},configurable:true,enumerable:false,writable:false}});}})();
(function(){{
